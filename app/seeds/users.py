...
def seed_users():
    ...
    c4 = User(firstname="Melba",email="mzanussii3@cs.com",password="Rendeng",image="https://randomuser.me/api/portraits/women/68.jpg")
    ...
    c6 = User(firstname="Mason",email="mcolbe5@webs.com",password="Makati City",image="https://randomuser.me/api/portraits/men/77.jpg")
    c7 = User(firstname="Liva",email="lmasi6@the.uk",password="CibeureSatu",image="https://randomuser.me/api/portraits/women/27.jpg")
    c8 = User(firstname="Hartley",email="hnias7@psu.edu",password="Lourenço",image="https://randomuser.me/api/portraits/men/92.jpg")
    c9 = User(firstname="Wadsworth",email="wmaccolm8@che.org",password="Cuispes",image="https://randomuser.me/api/portraits/men/76.jpg")
    c10 = User(firstname="Randell",email="rducrow9@qq.com",password="Obonoma",image="https://randomuser.me/api/portraits/men/85.jpg")
    c11 = User(firstname="Juana",email="jmcnamaraa@art.com",password="Malandag",image="https://randomuser.me/api/portraits/men/12.jpg")
